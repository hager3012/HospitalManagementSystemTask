        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateAndTime = table.Column<DateOnly>(type: "date", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MedicalHistories_Records_RecordId",
                        column: x => x.RecordId,
                        principalTable: "Records",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MedicalHistories_VitalSigns_VitalSignsId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateOfIllness = table.Column<DateOnly>(type: "date", nullable: false),
                    DurationOfIllness = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    FamilyHistory = table.Column<bool>(type: "bit", nullable: false),
                    MedicalHistoryId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Past_Illnesses", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Past_Illnesses_MedicalHistories_MedicalHistoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateOfSurgery = table.Column<DateOnly>(type: "date", nullable: false),
                    MedicalHistoryId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MedicalHistories_RecordId",
                table: "MedicalHistories",
                column: "RecordId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_MedicalHistories_VitalSignsId",
                table: "MedicalHistories",
                column: "VitalSignsId");

            migrationBuilder.CreateIndex(
                name: "IX_Past_Illnesses_MedicalHistoryId",
                table: "Past_Illnesses",
